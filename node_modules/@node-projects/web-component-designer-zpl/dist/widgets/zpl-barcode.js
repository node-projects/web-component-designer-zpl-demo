...
import { barcodeObservedAttributes, getBarcodeDefinition, getBarcodeFieldOriginOffset, readBarcodeProps } from '../barcodes/barcodeRegistry.js';
import { barcodeFieldOriginAboveOffset, barcodeHorizontalInsets, barcodeShowsInterpretation, barcodeTextAbove, barcodeTextZoneDots, renderBarcode } from '../barcodes/bwipRenderer.js';
export class ZplBarcode extends BaseCustomWebComponentConstructorAppend {
    ...
    constructor() {
        ...
        this._surface = this._getDomElement('barcode-surface');
        this._frame = this._getDomElement('barcode-frame');
        this._hri = this._getDomElement('hri');
        this._error = this._getDomElement('error');
    }
    ready() {
    ...
    attributeChangedCallback(_name, oldValue, newValue) {
        if (oldValue === newValue || !this._widgetReady)
            return;
        this.refreshFromAttributes();
    }
    get barcodeProps() {
    ...
    _setRotatedBounds(width, height, rotation) {
