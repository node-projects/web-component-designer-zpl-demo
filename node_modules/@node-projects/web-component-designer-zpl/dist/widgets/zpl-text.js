...
import { applyDeviceFontCase, getDeviceFontMetrics, loadZplFonts, zplFontFamilies } from '../fonts/zplFonts.js';
...
export function getZplTextOutputOffset(rotation) {
    switch (rotation) {
...
export class ZplText extends BaseCustomWebComponentConstructorAppend {
    ...
    `;
    static template = html `<div id="text-frame"><div id="text-div"></div></div>`;
    static is = 'zpl-text';
    ...
    constructor() {
        ...
        this._frame = this._getDomElement('text-frame');
    }
    ready() {
     ...
     */
    _measureTextWithoutLayout(content, fontSize, font) {
        try {
    ...
    get inlineEditElement() { return this._text; }
    get inlineEditContent() {
